...
typedef enum {
    ...
    OF_DS3231_NOT_FOUND,
    OF_BIRD_X_REWARD_REOPEN,
    OF_BIRD_X_REWARD_NO_REOPEN,
    OF_DOOR_CLOSE_SLOW_REOPEN,
    OF_SERVO_FAR_CLOSE_POS_REOPEN,
    OF_REWARD_TAKEN,
    OF_REWARD_TIMEOUT,
    OF_REWARD_TIMEOUT_WRONG,
    OF_ATTRACTIVE_LEDS_INIT,
    OF_PIT_TAG_DENIED,
    OF_PIT_TAG_NOT_LISTED_DENIED,
    OF_ATTRACTIVE_LEDS_PUNISHMENT,
    OF_RFID_TIMEOUT,
