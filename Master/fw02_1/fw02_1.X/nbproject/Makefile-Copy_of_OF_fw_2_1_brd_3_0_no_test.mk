...
${OBJECTDIR}/_ext/659850791/app_master.o: ../src/app/app_master.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/659850791" 
	@${RM} ${OBJECTDIR}/_ext/659850791/app_master.o.d 
	@${RM} ${OBJECTDIR}/_ext/659850791/app_master.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/app/app_master.c  -o ${OBJECTDIR}/_ext/659850791/app_master.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/659850791/app_master.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_Copy_of_OF_fw_2_1_brd_3_0_no_test=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mlarge-code -O0 -I"../src" -I"../src/app" -I"../src/driver" -I"../src/framework/fileio" -I"../src/framework/minini" -I"../src/framework/usb" -I"mcc_generated_files" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/659850791/app_master.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
